...
export class CategoriesService {
     ...
     */
    public getCategories(includeDisabled?: boolean, observe?: 'body', reportProgress?: boolean): Observable<Array<Category>>;
    public getCategories(includeDisabled?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Category>>>;
    public getCategories(includeDisabled?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Category>>>;
    public getCategories(includeDisabled?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
