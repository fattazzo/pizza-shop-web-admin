...
export type OrderState = 'PENDING' | 'PROCESSING' | 'COMPLETED' | 'CANCELLED' | 'FAILED' | 'REFUNDED';

export const OrderState = {
    PENDING: 'PENDING' as OrderState,
    PROCESSING: 'PROCESSING' as OrderState,
    COMPLETED: 'COMPLETED' as OrderState,
    CANCELLED: 'CANCELLED' as OrderState,
    FAILED: 'FAILED' as OrderState,
    REFUNDED: 'REFUNDED' as OrderState
};